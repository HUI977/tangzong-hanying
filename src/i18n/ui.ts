...
export interface UIStrings {
  ...
  quizSolved: string
  quizScore: string
  stopResidence: string
  stopPlace: string
  panelFooter: string
  poemSpotHint: string // 诗句地标卡「点击定位」提示
  tagNow: string
  tagTang: string
  // 弹窗
  popLocatedEyebrow: string // “此地，唐时在”
  popRuinsEyebrow: string // 周秦汉遗址弹窗眉题（如汉长安城、丰镐）
  popTombEyebrow: string // 帝陵弹窗眉题
  popLore: string // “典”
  imgPlaceholder: string // 坊卡占位图注记
  ward110: string // 「唐长安一百一十坊之一」
...
export const UI: Record<Locale, UIStrings> = {
  // ─────────────────────────────────────── English ───
  en: {
    subtitle: 'Tang traces, Han shadows — a thousand years at hand, all in one map',
    ...
    introList: [
      ...
      'The "Then & Now" panel lists twenty-four places you can still visit today',
    ],
    introBtn: 'Enter',
    ...
    panelTitle: 'Then & Now',
    panelSubtitle: "Twenty-four places of Chang'an you can still reach",
    panelCollapse: 'Collapse',
    tabTrace: 'Then & Now',
    tabPoems: 'Poems',
    tabAnecdotes: 'Anecdotes',
    trajTitle: "Poets' Ward Trails",
    trajSubtitle: 'Where the poets lived and roamed',
    quizTitle: 'Ward in a Verse',
    quizSubtitle: 'Guess the ward from the poem',
    quizPlaceholder: 'Ward name (e.g. Pingkang)',
    quizHintBtn: 'Hint',
    quizSubmit: 'Answer',
    quizCorrect: 'Splendid — that is the ward!',
    quizWrong: 'Not quite — think again',
    quizSolved: 'Solved',
    quizScore: 'Score',
    stopResidence: 'Residence',
    stopPlace: 'Haunt',
    panelFooter: 'Tap anywhere on the map to learn its Tang-era ward name',
    poemSpotHint: 'Tap to locate',
    tagNow: 'Now',
    tagTang: 'Tang',
    popLocatedEyebrow: 'In the Tang, this spot was in',
    popRuinsEyebrow: 'Historic site',
    popTombEyebrow: 'Imperial tomb',
    popLore: 'Lore',
    imgPlaceholder: 'IMAGE TO COME',
    ward110: "One of the 110 wards of Tang Chang'an",
  ...
  'zh-CN': {
    ...
    panelTitle: '古今寻迹',
    panelSubtitle: '二十四处可亲身抵达的长安',
    panelCollapse: '收起',
    tabTrace: '寻古觅今',
    tabPoems: '诗词歌赋',
    tabAnecdotes: '名人轶事',
    trajTitle: '诗人坊踪',
    trajSubtitle: '诗人在长安的坊宅与游踪',
    quizTitle: '诗中觅坊',
    quizSubtitle: '读诗句，猜坊名',
    quizPlaceholder: '输入坊名（如：平康）',
    quizHintBtn: '提示',
    quizSubmit: '作答',
    quizCorrect: '妙哉！正是此坊。',
    quizWrong: '再想想……',
  ...
  'zh-TW': {
    ...
    panelTitle: '古今尋蹟',
    panelSubtitle: '二十四處可親身抵達的長安',
    panelCollapse: '收起',
    tabTrace: '尋古覓今',
    tabPoems: '詩詞歌賦',
    tabAnecdotes: '名人軼事',
    trajTitle: '詩人坊蹤',
    trajSubtitle: '詩人在長安的坊宅與遊蹤',
    quizTitle: '詩中覓坊',
    quizSubtitle: '讀詩句，猜坊名',
    quizPlaceholder: '輸入坊名（如：平康）',
    quizHintBtn: '提示',
    quizSubmit: '作答',
    quizCorrect: '妙哉！正是此坊。',
    quizWrong: '再想想……',
  ...
  // ─────────────────────────────────────── 日本語 ───
  ja: {
    subtitle: '唐の蹤、漢の影、千年は尺のうち、尽く一図に',
    sourcesLink: '典拠と注',
    introTitle: '長安へようこそ',
    introBody:
    ...
    panelTitle: '今と昔',
    panelSubtitle: '今も訪れられる長安、二十四か所',
    panelCollapse: '閉じる',
    tabTrace: '古を尋ね今を覓む',
    tabPoems: '詩歌',
    tabAnecdotes: '逸話',
    trajTitle: '詩人の坊蹤',
    trajSubtitle: '詩人が長安で住み歩いた軌跡',
    quizTitle: '詩に坊を求む',
    quizSubtitle: '詩句から坊名を当てる',
    quizPlaceholder: '坊名を入力（例：平康）',
    quizHintBtn: 'ヒント',
    quizSubmit: '回答',
    quizCorrect: '見事！その坊です。',
    quizWrong: 'もう一度……',
    quizSolved: '済',
    quizScore: '得点',
    stopResidence: '住居',
    ...
    popRuinsEyebrow: '周秦漢の遺跡',
    popTombEyebrow: '帝王陵',
    popLore: '逸話',
    imgPlaceholder: '画像準備中',
    ward110: '唐長安一百十坊の一つ',
  ...
  ko: {
    ...
    introList: [
      ...
      '「고금 탐방」 패널은 오늘날에도 갈 수 있는 장안 스물네 곳',
    ],
    introBtn: '입 성',
    presetNow: '현대 시안',
    presetOverlay: '겹쳐 보기',
    ...
    panelTitle: '고금 탐방',
    panelSubtitle: '직접 가볼 수 있는 장안 스물네 곳',
    panelCollapse: '접기',
    tabTrace: '옛것을 찾아 오늘을 헤아리다',
    tabPoems: '시가',
    tabAnecdotes: '일화',
    trajTitle: '시인의 방 자취',
    trajSubtitle: '시인이 장안에서 살고 다닌 발자취',
    quizTitle: '시구 속 방 찾기',
    quizSubtitle: '시구를 읽고 방 이름을 맞히세요',
    quizPlaceholder: '방 이름 입력 (예: 평강)',
    quizHintBtn: '힌트',
    quizSubmit: '정답',
    quizCorrect: '훌륭해요! 바로 그 방입니다.',
    quizWrong: '다시 생각해 보세요……',
    quizSolved: '해결',
    quizScore: '점수',
    stopResidence: '거처',
    stopPlace: '행처',
    ...
    popRuinsEyebrow: '주진한 유적',
    popTombEyebrow: '제릉',
    popLore: '일화',
    imgPlaceholder: '이미지 준비 중',
    ward110: '당 장안 110방 중 하나',
